...
public class Buying extends Fragment {
    ...
    private RecyclerView rcvBuying;
    public Buying() {}

    public static Buying newInstance(String stdId) {
        Buying fragment = new Buying();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcvBuying = view.findViewById(R.id.rcvBuying);
        rcvBuying.setHasFixedSize(true);
        LinearLayoutManager layoutManager = new LinearLayoutManager(requireContext());
        rcvBuying.setLayoutManager(layoutManager);

        ordersList = new ArrayList<>();
        adapter = new OrdersAdapter(new ArrayList<>());
        rcvBuying.setAdapter(adapter);

        // Gửi dữ liệu lên server
        Map<String, String> dataToSend = new HashMap<>();
        dataToSend.put("acc_id", stdId);
        dataToSend.put("order_status", "Đặt đơn");
        GetBuying(dataToSend);
        
        return view;
    }

    private void GetBuying(Map<String, String> dataToSend) {
                ...
                try {
                    ...
                    if (responseObject.has("message")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            ordersList.add(new Orders(order_id, total_payment_amount, order_content.toString(), payment_method, null));
                        }
