...
public class Bought extends Fragment {
    String stdId;
    private List<Orders> ordersList;
    private OrdersAdapter adapter;
    private RetrofitManager retrofitManagerB;
    private RecyclerView rcvBought;
    public Bought() {}
    public static Bought newInstance(String stdId) {
        Bought fragment = new Bought();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcvBought = view.findViewById(R.id.rcvBought);
        rcvBought.setHasFixedSize(true);
        LinearLayoutManager layoutManager = new LinearLayoutManager(requireContext());
        rcvBought.setLayoutManager(layoutManager);

        ordersList = new ArrayList<>();
        adapter = new OrdersAdapter(new ArrayList<>());
        rcvBought.setAdapter(adapter);

        // Gửi dữ liệu lên server
        Map<String, String> dataToSend = new HashMap<>();
        dataToSend.put("acc_id", stdId);
        dataToSend.put("order_status", "Hoàn thành");
        GetBought(dataToSend);
        return view;
    }

    private void GetBought(Map<String, String> dataToSend) {
